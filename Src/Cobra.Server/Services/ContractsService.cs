...
namespace Cobra.Server.Services
{
    public class ContractsService : IContractsService
    {
        ...
        private static readonly string _contractsPath = Path.Combine("Data", "Contracts");
        ...
        public void RemoveContract(string contractId)
        {
            ...
            var contractsPath = Path.Combine(_contractsPath, $"{contractId}.json");
